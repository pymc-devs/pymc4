...
# Use `float64` datatype as PSD conditions fail with `float32`.
COV_FUNCS = [
    (
        "ExpQuad",
        {
            ...
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.01831564], [0.01831564, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "Constant",
        {
            "coef": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 1.0], [1.0, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "WhiteNoise",
        {
            "noise": np.float64(1e-4),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1e-4, 0.0], [0.0, 1e-4]], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "RatQuad",
        {
            "amplitude": np.float64(1.0),
            "length_scale": np.float64(1.0),
            "scale_mixture_rate": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.2], [0.2, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "Matern12",
        {
            ...
            "length_scale": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.05910575], [0.05910575, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "Matern32",
        {
            ...
            "length_scale": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.04397209], [0.04397209, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "Matern52",
        {
            ...
            "length_scale": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.03701404], [0.03701404, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "Exponential",
        {
            ...
            "length_scale": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.24311673], [0.24311673, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
        "Gibbs",
        {
            "length_scale_fn": (lambda x: tf.ones(x.shape, dtype=tf.float64)),
            "test_points": [np.array([[1.0], [3.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.13533528], [0.13533528, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
            "dtype": tf.float64,
        },
    ...
    (
        "Linear",
        {
            "bias_variance": np.float64(1.0),
            "slope_variance": np.float64(1.0),
            "shift": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[2.0, 4.0], [4.0, 14.0]], dtype=np.float64),
            "expected_point": np.array([2.0, 14.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
    (
    ...
    (
        "Cosine",
        {
            ...
            "amplitude": np.float64(1.0),
            "test_points": [np.array([[1.0, 2.0], [3.0, 4.0]], dtype=np.float64)] * 2,
            "expected_matrix": np.array([[1.0, 0.47307032], [0.47307032, 1.0]], dtype=np.float64),
            "expected_point": np.array([1.0, 1.0], dtype=np.float64),
            "feature_ndims": 1,
        },
    ),
...
def test_cov_funcs_matrix_shape_psd(tf_seed, get_data, get_unique_cov_func):
    ...
    try:
        ...
        pytest.xfail("PSD condition failed for '{}'.".format(kernel.__class__.__name__))
...
def test_cov_non_cov_combination(get_cov_func):
    ...
    others = [np.float64(2.0), np.array([2.0], dtype=np.float64)]
    for other in others:
...
def test_cov_funcs_active_dims(tf_seed):
    X1 = tf.random.normal((20, 10, 5, 5, 3), dtype=tf.float64)
    X2 = tf.random.normal((20, 10, 5, 5, 3), dtype=tf.float64)
    feature_ndims = 3
    refkernel = pm.gp.cov.ExpQuad(np.float64(1.0), np.float64(1.0), 3)
...
def test_cov_funcs_invalid_feature_ndims():
    ...
    with pytest.raises(ValueError, match=r"expected 'feature_ndims' to be an integer"):
        kernel = pm.gp.cov.ExpQuad(np.float64(1.0), np.float64(1.0), feature_ndims)
...
def test_scaled_cov_kernel_shapes_and_psd(tf_seed, get_data):
    ...
    k = pm.gp.cov.ExpQuad(np.float64(1.0), feature_ndims=len(feature_shape))
    scal_fn = lambda x: tf.ones(x.shape, dtype=tf.float64)
...
def test_scaled_cov():
    ...
    k = pm.gp.cov.ExpQuad(np.float64(1.0))
    scal_fn = lambda x: tf.ones(x.shape, dtype=tf.float64)
    k_scal = pm.gp.cov.ScaledCov(k, scal_fn)

    cov = k_scal(x, x)
    expected = tf.constant([[2.0, 0.03663128], [0.03663128, 2.0]], dtype=np.float64)
